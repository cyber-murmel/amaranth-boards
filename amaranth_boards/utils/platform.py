...
from ..chubbyhat_v0_1 import ChubbyHatV0_1Platform
from ..chubbyhat_v0_2 import ChubbyHatV0_2Platform
...
def get_platform_by_name(name):
    ...
    if "ChubbyHatV0_1" == name:
        return ChubbyHatV0_1Platform
    if "ChubbyHatV0_2" == name:
        return ChubbyHatV0_2Platform
